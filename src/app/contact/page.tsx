      ...
      <section className="bg-primary-dark py-24 md:py-28 text-chrome" aria-label="Contact hero">
        <div className="container-wide text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display uppercase mt-3 mb-5">
            Contact <span className="text-accent-text">Elite</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-3xl md:text-4xl text-chrome mb-7">
                Reach Out <span className="text-accent-text">Directly</span>
              </h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-sm bg-accent/15 border border-accent/40 flex items-center justify-center shrink-0">
                    <svg className="w-5 h-5 text-accent-text" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-accent-text font-display uppercase tracking-widest text-xs mb-1">Phone</p>
                    <a href="tel:+19852583831" className="text-chrome hover:text-accent-text transition-colors text-xl font-display tracking-wider">
                      (985) 258-3831
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    <p className="text-accent-text font-display uppercase tracking-widest text-xs mb-1">Email</p>
                    <a href="mailto:elitecustomautollc@gmail.com" className="text-chrome hover:text-accent-text transition-colors break-all">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-accent-text font-display uppercase tracking-widest text-xs mb-1">Shop Location</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-accent-text font-display uppercase tracking-widest text-xs mb-1">Hours</p>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-11 h-11 rounded-sm bg-accent/15 border border-accent/40 flex items-center justify-center shrink-0">
                    <svg className="w-5 h-5 text-accent-text" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                    </svg>
                  </div>
                  <div>
                    <p className="text-accent-text font-display uppercase tracking-widest text-xs mb-1">Facebook</p>
                    <a
                      href="https://www.facebook.com/profile.php?id=61573142575763"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-chrome hover:text-accent-text transition-colors"
                    >
            ...
            <div className="lg:col-span-3">
              <h2 id="contact-form-heading" className="text-3xl md:text-4xl text-chrome mb-7">
                Send Us a <span className="text-accent-text">Message</span>
              </h2>
